<div id="content">
	<div class="container" id="process">
		<div class="processes index">
			<h2 class="title-divider">
				<span>
					<?php echo __('Processes'); ?>					<span class="de-em">
						list
					</span>
				</span>
			</h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $process['Process']['id']), null, __('Are you sure you want to delete # %s?', $process['Process']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
			</table>
