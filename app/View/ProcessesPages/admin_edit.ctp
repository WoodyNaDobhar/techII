...
<?php echo $this->Form->end(); ?>
		...
		<div class="actions">
			...
			<ul>
						...
						<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProcessesPage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProcessesPage.id'))); ?></li>
